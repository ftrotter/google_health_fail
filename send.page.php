...
*/
	...
	// The first option is always to send a message directly to the patient!
	$patient_option = "<option value='0_$patient_id'>$patient_name (this patient)</option>";
	$select .= $patient_option;
