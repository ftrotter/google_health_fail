	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "de,en,en-au,en-ca,en-us,es,fr,it,ja,ko,pt,zh,zh-tw,ROOT");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "de,de-de,en,en-au,en-gb,en-us,es,es-es,fr,it,ja,ja-jp,ko,ko-kr,pt,zh,zh-cn,zh-tw,ROOT");
				}
			},
			runTest: function(t){
